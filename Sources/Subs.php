 ...
 * @return boolean  true if the file/dir is already writable or the fucntion was able to make it writable, false if the function couldn't make the file/dir writable.
 */
