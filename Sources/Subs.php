	...
	if (empty($bbc_codes) || $message === false || !empty($parse_tags))
	{
		...
		*/
		...
		$codes = array(
			...
			array(
				'tag' => 'quote',
				'before' => '<blockquote><div class="quoteheader">' . $txt['quote'] . '</div>',
				'after' => '</blockquote>',
				'trim' => 'both',
				'block_level' => true,
			),
			array(
				...
				'before' => '<blockquote><div class="quoteheader">' . $txt['quote_from'] . ': <span>{author}</span></div>',
				'after' => '</blockquote>',
				'trim' => 'both',
				'block_level' => true,
			),
			array(
				'tag' => 'quote',
				'type' => 'parsed_equals',
				'before' => '<blockquote><div class="quoteheader">' . $txt['quote_from'] . ': $1</div>',
				'after' => '</blockquote>',
				'trim' => 'both',
				'quoted' => 'optional',
			...
			array(
				...
				'before' => '<blockquote><div class="quoteheader"><a href="' . $scripturl . '?{link}">' . $txt['quote_from'] . ': <span>{author}</span> ' . $txt['on'] . ' {date}</a></div>',
				'after' => '</blockquote>',
				'trim' => 'both',
				'block_level' => true,
			),
