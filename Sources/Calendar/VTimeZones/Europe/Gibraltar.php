...
class Gibraltar extends \SMF\Calendar\VTimeZone
{
	 ...
	 */
	public string $tzid = 'Europe/Gibraltar';
	...
	public array $components = [
		...
		16 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=9;BYDAY=SU;BYMONTHDAY=16,17,18,19,20,21,22;UNTIL=19240921T010000Z',
			'TZNAME' => 'GMT',
			'TZOFFSETFROM' => '+0100',
			'TZOFFSETTO' => '+0000',
		],
		...
		18 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=4;BYDAY=SU;BYMONTHDAY=16,17,18,19,20,21,22;UNTIL=19260418T020000Z',
			'TZNAME' => 'BST',
			'TZOFFSETFROM' => '+0000',
			'TZOFFSETTO' => '+0100',
		],
		...
		33 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=8;BYDAY=SU;BYMONTHDAY=9,10,11,12,13,14,15;UNTIL=19430814T230000Z',
			'TZNAME' => 'BST',
			'TZOFFSETFROM' => '+0200',
			'TZOFFSETTO' => '+0100',
		],
		34 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=4;BYDAY=SU;BYMONTHDAY=2,3,4,5,6,7,8;UNTIL=19440402T000000Z',
			'TZNAME' => 'BDST',
			'TZOFFSETFROM' => '+0100',
			'TZOFFSETTO' => '+0200',
		],
		...
		38 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=10;BYDAY=SU;BYMONTHDAY=2,3,4,5,6,7,8;UNTIL=19461006T010000Z',
			'TZNAME' => 'GMT',
			'TZOFFSETFROM' => '+0100',
			'TZOFFSETTO' => '+0000',
		],
