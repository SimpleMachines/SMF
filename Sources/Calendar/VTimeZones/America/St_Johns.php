...
class St_Johns extends \SMF\Calendar\VTimeZone
{
	...
	public array $components = [
		...
		1 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=5;BYDAY=1SU;UNTIL=19350506T023000Z',
			'TZNAME' => 'NDT',
			'TZOFFSETFROM' => '-0330',
			'TZOFFSETTO' => '-0230',
		],
		2 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=10;BYDAY=-1SU;UNTIL=19351028T013000Z',
			'TZNAME' => 'NST',
			'TZOFFSETFROM' => '-0230',
			'TZOFFSETTO' => '-0330',
		],
		...
		16 => [
			'type' => 'STANDARD',
			'DTSTART' => '19871025T000100',
			'RRULE' => 'FREQ=YEARLY;BYMONTH=10;BYDAY=-1SU;UNTIL=20061029T013100Z',
			'TZNAME' => 'NST',
			'TZOFFSETFROM' => '-0130',
			'TZOFFSETTO' => '-0330',
		],
