 ...
 */
class Mendoza extends \SMF\Calendar\VTimeZone
{
	/*******************
	 * Public properties
	 *******************/
	 ...
	 */
	public string $tzid = 'America/Argentina/Mendoza';
	...
	public array $components = [
		...
		4 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=3;BYMONTHDAY=1;UNTIL=19400301T030000Z',
			'TZNAME' => 'UTC-04',
			'TZOFFSETFROM' => '-0300',
			'TZOFFSETTO' => '-0400',
		],
		5 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=11;BYMONTHDAY=1;UNTIL=19391101T040000Z',
			'TZNAME' => 'UTC-03',
			'TZOFFSETFROM' => '-0400',
			'TZOFFSETTO' => '-0300',
		],
		...
		15 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=3;BYMONTHDAY=1;UNTIL=19660301T030000Z',
			'TZNAME' => 'UTC-04',
			'TZOFFSETFROM' => '-0300',
			'TZOFFSETTO' => '-0400',
		],
		16 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=10;BYMONTHDAY=15;UNTIL=19661015T040000Z',
			'TZNAME' => 'UTC-03',
			'TZOFFSETFROM' => '-0400',
			'TZOFFSETTO' => '-0300',
		],
		...
		31 => [
			'type' => 'DAYLIGHT',
			'DTSTART' => '19891015T000000',
			'RRULE' => 'FREQ=YEARLY;BYMONTH=10;BYDAY=3SU;UNTIL=19921018T040000Z',
			'TZNAME' => 'UTC-02',
			'TZOFFSETFROM' => '-0400',
			'TZOFFSETTO' => '-0200',
		],
