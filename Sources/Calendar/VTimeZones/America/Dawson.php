...
class Dawson extends \SMF\Calendar\VTimeZone
{
	 ...
	 */
	public string $tzid = 'America/Dawson';
	...
	public array $components = [
		...
		14 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=3;BYDAY=2SU;UNTIL=20200308T100000Z',
			'TZNAME' => 'PDT',
			'TZOFFSETFROM' => '-0800',
			'TZOFFSETTO' => '-0700',
		],
		15 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=11;BYDAY=1SU;UNTIL=20201101T090000Z',
			'TZNAME' => 'PST',
			'TZOFFSETFROM' => '-0700',
			'TZOFFSETTO' => '-0800',
		],
