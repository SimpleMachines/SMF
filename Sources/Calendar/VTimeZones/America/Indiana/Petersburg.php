 ...
 */
class Petersburg extends \SMF\Calendar\VTimeZone
{
	/*******************
	 * Public properties
	 *******************/
	 ...
	 */
	public string $tzid = 'America/Indiana/Petersburg';
	...
	public array $components = [
		...
		8 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=4;BYDAY=-1SU;UNTIL=19640426T020000',
			'TZNAME' => 'CDT',
			'TZOFFSETFROM' => '-0600',
			'TZOFFSETTO' => '-0500',
		],
		9 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=10;BYDAY=-1SU;UNTIL=19641025T020000',
			'TZNAME' => 'CST',
			'TZOFFSETFROM' => '-0500',
			'TZOFFSETTO' => '-0600',
		],
