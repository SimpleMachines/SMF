...
class Eirunepe extends \SMF\Calendar\VTimeZone
{
	...
	public array $components = [
		...
		2 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=4;BYMONTHDAY=1;UNTIL=19330401T040000Z',
			'TZNAME' => 'UTC-05',
			'TZOFFSETFROM' => '-0400',
			'TZOFFSETTO' => '-0500',
		],
		...
		4 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=12;BYMONTHDAY=1;UNTIL=19521201T050000Z',
			'TZNAME' => 'UTC-04',
			'TZOFFSETFROM' => '-0500',
			'TZOFFSETTO' => '-0400',
		],
		...
		6 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=4;BYMONTHDAY=1;UNTIL=19520401T040000Z',
			'TZNAME' => 'UTC-05',
			'TZOFFSETFROM' => '-0400',
			'TZOFFSETTO' => '-0500',
		],
		...
		13 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=3;BYMONTHDAY=1;UNTIL=19680301T040000Z',
			'TZNAME' => 'UTC-05',
			'TZOFFSETFROM' => '-0400',
			'TZOFFSETTO' => '-0500',
		],
		14 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=11;BYMONTHDAY=1;UNTIL=19671101T050000Z',
			'TZNAME' => 'UTC-04',
			'TZOFFSETFROM' => '-0500',
			'TZOFFSETTO' => '-0400',
		],
		...
		21 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=10;BYDAY=SU;BYMONTHDAY=11,12,13,14,15,16,17;UNTIL=19951015T050000Z',
			'TZNAME' => 'UTC-04',
			'TZOFFSETFROM' => '-0500',
			'TZOFFSETTO' => '-0400',
		],
		22 => [
			...
			'RRULE' => 'FREQ=YEARLY;BYMONTH=2;BYDAY=3SU;UNTIL=19950219T040000Z',
			'TZNAME' => 'UTC-05',
			'TZOFFSETFROM' => '-0400',
			'TZOFFSETTO' => '-0500',
		],
