...
function Display()
{
	...
	$context['normal_buttons'] = array(
		...
		'print' => array('test' => 'can_print', 'text' => 'print', 'image' => 'print.png', 'lang' => true, 'custom' => 'rel="nofollow"', 'class' => 'new_win', 'url' => $scripturl . '?action=printpage;topic=' . $context['current_topic'] . '.0'),
	);
