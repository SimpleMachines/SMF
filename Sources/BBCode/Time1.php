...
/**
 * Represents the unparsed_equals_content version of the time BBCode.
 */
class Time1 extends BBCode
{
	/*******************
	 * Public properties
	 *******************/
	 ...
	 *
	 */
	public ?string $content = '<time class="bbc_time" datetime="$2">$1</time>';
