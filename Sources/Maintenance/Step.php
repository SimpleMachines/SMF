...
class Step
{
	 ...
	 * Callable to call.
	 *
	 * This can either be a fully qualified callable, or else the bare name
	 * of a method in the Tool class that owns this Step instance.
	 */
	 ...
	 * @var string
	 *
	 * Name of the theme sub-template to use to display this step.
	 */
	 ...
	 * @param array|string $function Function to call.
	 ...
	 *    If null, will be determined from $function.
	 */
	public function __construct(int $id, string $name, array|string $function, int $progress, ?string $title = null, ?string $template = null)
	{
		$this->id = $id;
		$this->name = $name;
		$this->title = $title;
	 ...
	 *
	 * @return array|string Function to call. This is actually the method inside the
