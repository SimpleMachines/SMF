...
class InstantMessages9 extends MigrationBase
{
	/*******************
	 * Public properties
	 *******************/
	 ...
	 *
	 */
	public string $name = 'Recounting unread instant messages';
	...
	public function execute(): bool
	{
		...
		do {
			...
			Db::$db->update_from(
				...
				set: 'mem.unreadMessages = COALESCE(pmr.num_messages, mem.unreadMessages)',
				where: '',
				db_values: [
