...
class HolidaysToEvents extends MigrationBase
{
	/*******************
	 * Public properties
	 *******************/
	 ...
	 *
	 */
	public string $name = 'Migrating holidays to events';
	 ...
	 * @var array
	 *
	 * Data for holidays that are included in SMF's default when installing.
	 */
	private array $known_holidays = [
		'April Fools' => [
