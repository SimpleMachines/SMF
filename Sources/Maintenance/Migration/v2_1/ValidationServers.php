...
class ValidationServers extends MigrationBase
{
	...
	{
		$table = new \SMF\Db\Schema\v2_1\PackageServers();
		...
		if (empty($downloads_server)) {
			Db::$db->insert(
				...
				[
					[
						'Simple Machines Download Site',
						'https://download.simplemachines.org/browse.php?api=v1;smf_version={SMF_VERSION}',
						'https://download.simplemachines.org/validate.php?api=v1;smf_version={SMF_VERSION}',
					],
				],
				['id_server'],
			);
