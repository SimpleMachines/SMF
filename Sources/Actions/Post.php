	...
	protected function loadEditor(): void
	{
		...
		if (Utils::$context['can_post_attachment']) {
			...
			$editorOptions['options']['fileUploadOptions'] = [
				'dictDefaultMessage' => Lang::getTxt('attach_drop_zone', file: 'Post'),
				'dictFallbackMessage' => Lang::getTxt('attach_drop_zone_no', file: 'Post'),
				'dictCancelUpload' => Lang::getTxt('modify_cancel', file: 'Post'),
				'genericError' => Lang::getTxt('attach_php_error', file: 'Post'),
				'text_attachDropzoneLabel' => Lang::getTxt('attach_drop_zone', file: 'Post'),
				'text_attachLimitNag' => Lang::getTxt('attach_limit_nag', file: 'Post'),
				'text_attachLeft' => Lang::getTxt('attachments_left', file: 'Post'),
				'text_deleteAttach' => Lang::getTxt('attached_file_delete', file: 'Post'),
				'text_attachDeleted' => Lang::getTxt('attached_file_deleted', file: 'Post'),
				'text_insertBBC' => Lang::getTxt('attached_insert_bbc', file: 'Post'),
				'text_attachUploaded' => Lang::getTxt('attached_file_uploaded', file: 'Post'),
				'text_attach_unlimited' => Lang::getTxt('attach_drop_unlimited', file: 'Post'),
				'text_totalMaxSize' => Lang::getTxt('attach_max_total_file_size_current', file: 'Post'),
				'text_max_size_progress' => '{currentRemain} ' . (Config::$modSettings['attachmentPostLimit'] >= 1024 ? Lang::getTxt('megabyte', file: 'General') : Lang::getTxt('kilobyte', file: 'General')) . ' / {currentTotal} ' . (Config::$modSettings['attachmentPostLimit'] >= 1024 ? Lang::getTxt('megabyte', file: 'General') : Lang::getTxt('kilobyte', file: 'General')),
				'dictMaxFilesExceeded' => Lang::getTxt('more_attachments_error', file: 'Post'),
