...
class Logging
{
	 ...
	 */
	public static function logAction($action, array $extra = array(), $log_type = 'moderate'): int
	{
	 ...
	 */
	public static function trackStats($stats = array()): bool
	{
		...
		if (!isset(Config::$modSettings['mostOnlineUpdated']) || Config::$modSettings['mostOnlineUpdated'] != $date)
		{
			...
			else
			{
				...
				if ($total_users_online > Config::$modSettings['mostOnlineToday'])
					self::trackStats(array('most_on' => $total_users_online));
