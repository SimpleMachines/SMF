...
function ModifyGeneralSettings($return_config = false)
{
	...
	$config_vars = array(
		...
		'',
		array('http_dns_prefetch_domains', $txt['http_dns_prefetch_domains'], 'db', 'large_text', 4, 'http_dns_prefetch_domains'),
		'',
		array('http_dns_preconnect_domains', $txt['http_dns_preconnect_domains'], 'db', 'large_text', 4, 'http_dns_preconnect_domains'),
		'',
