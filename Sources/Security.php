...
class Security
{
	...
	{
		if (isset($_GET['confirm']) && isset($_SESSION['confirm_' . $action]) && hash_hmac('md5', $_SERVER['HTTP_USER_AGENT'], $_GET['confirm']) == $_SESSION['confirm_' . $action])
		{
			return true;
		}
		else
	 ...
	 */
	public static function checkSubmitOnce(string $action, bool $is_fatal = true): null|bool
	{
