...
class Topics extends Table
{
	...
	public function __construct()
	{
		...
		$this->indexes = [
			...
			'last_message_sticky' => new DbIndex(
				name: 'last_message_sticky',
				columns: [
					[
						'name' => 'id_board',
					],
