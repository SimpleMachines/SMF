...
function utf8_regex_joining_type()
{
	return array(
		'Arabic' => array(
			...
			'Transparent' => '\x{0610}-\x{061A}\x{061C}\x{061C}\x{064B}-\x{065F}\x{0670}\x{06D6}-\x{06DC}\x{06DF}-\x{06E4}\x{06E7}-\x{06E8}\x{06EA}-\x{06ED}\x{0898}-\x{089F}\x{08CA}-\x{08E1}\x{08E3}-\x{0902}\x{102E0}\x{10EFD}-\x{10EFF}',
		),
		'Syriac' => array(
			'Join_Causing' => '\x{0640}',
...
function utf8_regex_indic()
{
	return array(
		'Devanagari' => array(
			'All' => '\x{0900}-\x{0952}\x{0955}-\x{0966}\x{0966}-\x{096A}\x{096A}-\x{096E}\x{096E}-\x{097F}\x{1CD0}-\x{1CD4}\x{1CD6}-\x{1CDC}\x{1CDE}-\x{1CF4}\x{1CF6}\x{1CF8}\x{20F0}\x{A830}\x{A833}\x{A836}\x{A838}-\x{A839}\x{A8E0}-\x{A8F1}\x{A8F1}-\x{A8F3}\x{A8F3}-\x{A8FF}\x{11B00}-\x{11B09}',
		...
		'Khojki' => array(
			'All' => '\x{0AE7}\x{0AE9}\x{0AEB}\x{0AED}\x{0AEF}\x{A834}\x{A837}-\x{A83A}\x{11200}-\x{11211}\x{11213}-\x{11241}',
			'Letter' => '\x{11200}-\x{11211}\x{11213}-\x{1122B}\x{1123F}-\x{11240}',
			'Nonspacing_Combining_Mark' => '\x{11236}',
			'Nonspacing_Mark' => '\x{1122F}-\x{11231}\x{11234}\x{11236}-\x{11237}\x{1123E}\x{11241}',
			'Virama' => '\x{11235}',
			'Vowel_Dependent' => '\x{1122C}-\x{1122E}\x{1122F}-\x{11231}\x{11232}-\x{11233}\x{11241}',
		),
		'Takri' => array(
