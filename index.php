...
function smf_main()
{
	...
	$no_stat_actions = array('dlattach', 'findmember', 'jsoption', 'likes', 'loadeditorlocale', 'modifycat', 'requestmembers', 'suggest', '.xml', 'xmlhttp', 'verificationcode', 'viewquery', 'viewsmfile');
