...
function template_registration_form()
{
	...
	echo '
		...
		<form action="', !empty(Config::$modSettings['force_ssl']) ? strtr(Config::$scripturl, ['http://' => 'https://']) : Config::$scripturl, '?action=signup2" method="post" accept-charset="UTF-8" name="registration" class="windowbg form_grid" onsubmit="return verifyAgree();">
			<div class="title_bar">
