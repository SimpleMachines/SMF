	...
	echo '
		<form action="', Config::$scripturl, '?action=admin;area=scheduledtasks;sa=taskedit;save;tid=', Utils::$context['task']['id'], '" method="post" accept-charset="', Utils::$context['character_set'], '">
			...
			<div class="information">
				<em>', sprintf($txt['scheduled_task_time_offset'], Utils::$context['server_time']), ' </em>
			</div>
			<div class="windowbg">
				<dl class="settings">
					<dt>
					...
					<dd>
						...
						<select name="unit">
							<option value="m"', empty(Utils::$context['task']['unit']) || Utils::$context['task']['unit'] == 'm' ? ' selected' : '', '>', $txt['scheduled_task_reg_unit_m'], '</option>
							<option value="h"', Utils::$context['task']['unit'] == 'h' ? ' selected' : '', '>', $txt['scheduled_task_reg_unit_h'], '</option>
							<option value="d"', Utils::$context['task']['unit'] == 'd' ? ' selected' : '', '>', $txt['scheduled_task_reg_unit_d'], '</option>
							<option value="w"', Utils::$context['task']['unit'] == 'w' ? ' selected' : '', '>', $txt['scheduled_task_reg_unit_w'], '</option>
						</select>
					</dd>
					<dt>
