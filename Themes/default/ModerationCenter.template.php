				...
				aSwapLinks: [
					{
						...
						msgExpanded: ', JavaScriptEscape(Lang::$txt['mc_group_requests']), ',
						msgCollapsed: ', JavaScriptEscape(Lang::$txt['mc_group_requests']), '
					}
				],
				oThemeOptions: {
				...
				aSwapLinks: [
					{
						...
						msgExpanded: ', JavaScriptEscape(Lang::$txt['mc_watched_users']), ',
						msgCollapsed: ', JavaScriptEscape(Lang::$txt['mc_watched_users']), '
					}
				],
				oThemeOptions: {
					bUseThemeSettings: true,
				...
				aSwapLinks: [
					{
						...
						msgExpanded: ', JavaScriptEscape(Lang::$txt['mc_recent_user_reports']), ',
						msgCollapsed: ', JavaScriptEscape(Lang::$txt['mc_recent_user_reports']), '
					}
				],
				oThemeOptions: {
					bUseThemeSettings: true,
