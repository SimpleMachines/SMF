...
function template_watched_users()
{
	echo '
		<div class="cat_bar">
			...
			<span id="watched_users_toggle" class="', !empty(Utils::$context['admin_prefs']['mcwu']) ? 'toggle_down' : 'toggle_up', '" title="', Lang::getTxt(empty(Utils::$context['admin_prefs']['mcgr']) ? 'hide' : 'show', file: 'General'), '" style="display: none;"></span>
		</div>
...
function template_reported_posts_block()
{
	echo '
		<div class="cat_bar">
			...
			<span id="reported_posts_toggle" class="', !empty(Utils::$context['admin_prefs']['mcrp']) ? 'toggle_down' : 'toggle_up', '" title="', Lang::getTxt(empty(Utils::$context['admin_prefs']['mcwu']) ? 'hide' : 'show', file: 'General'), '" style="display: none;"></span>
		</div>
