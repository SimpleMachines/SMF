...
function template_group_requests_block()
{
	...
	echo '
		<div class="cat_bar">
			<h3 class="catbg">
				<span id="group_requests_toggle" class="', !empty($context['admin_prefs']['mcgr']) ? 'toggle_down' : 'toggle_up', ' floatright" title="', !$context['admin_prefs']['mcgr'] ? $txt['hide'] : $txt['show'], '" style="display: none;"></span>
...
function template_watched_users()
{
	...
	echo '
		<div class="cat_bar">
			<h3 class="catbg">
				<span id="watched_users_toggle" class="', !empty($context['admin_prefs']['mcwu']) ? 'toggle_down' : 'toggle_up', ' floatright" title="', !$context['admin_prefs']['mcwu'] ? $txt['hide'] : $txt['show'], '" style="display: none;"></span>
...
function template_reported_posts_block()
{
	...
	echo '
		<div class="cat_bar">
			<h3 class="catbg">
				<span id="reported_posts_toggle" class="', !empty($context['admin_prefs']['mcrp']) ? 'toggle_down' : 'toggle_up', ' floatright" title="', !$context['admin_prefs']['mcrp'] ? $txt['hide'] : $txt['show'], '" style="display: none;"></span>
...
function template_reported_users_block()
{
	...
	echo '
		<div class="cat_bar">
			<h3 class="catbg">
				<span id="reported_users_toggle" class="', !empty($context['admin_prefs']['mcur']) ? 'toggle_down' : 'toggle_up', ' floatright" title="', !$context['admin_prefs']['mcur'] ? $txt['hide'] : $txt['show'], '" style="display: none;"></span>
