...
function template_login()
{
	...
	if (!empty($context['from_ajax']) && (empty($modSettings['force_ssl']) || $modSettings['force_ssl'] < 1))
		echo '
						form = $("#frmLogin");
...
function template_admin_login()
{
	...
	echo '
	<form action="', !empty($modSettings['force_ssl']) && $modSettings['force_ssl'] < 1 ? strtr($scripturl, array('http://' => 'https://')) : $scripturl, $context['get_data'], '" method="post" accept-charset="', $context['character_set'], '" name="frmLogin" id="frmLogin">
