 ...
 *
 * Both `$smileyContainer` and `$bbcContainer` can be one of three types:
 *
 * - a `string`, in which case the container is the HTML element specified by ID;
 * - `true`, where the container is generated by the JavaScript;
 * - and `null`, hides the container regardless of settings.
 *
 * @param string           $editor_id       The editor ID
 * @param null|bool|string $smileyContainer If null, hides the smiley section regardless of settings
 * @param null|bool|string $bbcContainer    If null, hides the bbcode buttons regardless of settings
 */
function template_control_richedit(string $editor_id, null|bool|string $smileyContainer = null, null|bool|string $bbcContainer = null): void
{
	...
	echo '
		...
		<script>
			document.addEventListener("DOMContentLoaded", function () {
				...
				sceditor.create(textarea, options, ' . Utils::escapeJavaScript($bbcContainer) . ', ' . Utils::escapeJavaScript($smileyContainer) . ');
			});
		</script>';
}
