...
function template_new_group()
{
	...
	if ($context['post_group'] || $context['undefined_group'])
		echo '
					...
					<dd>
						<input type="number" name="min_posts" id="min_posts_input">
					</dd>';
...
function template_edit_group()
{
	...
	if ($context['group']['allow_post_group'])
		echo '
					...
					<dd>
						<input type="number" name="min_posts" id="min_posts_input"', $context['group']['is_post_group'] ? ' value="' . $context['group']['min_posts'] . '"' : '', '>
					</dd>';
	...
	echo '
					...
					<dd>
						<input type="number" name="icon_count" id="icon_count_input" value="', $context['group']['icon_count'], '">
					</dd>';
