...
function template_show_settings()
{
	...
	echo '
						<form id="admin_form_wrapper" action="', Utils::$context['post_url'], '" method="post" accept-charset="UTF-8"', !empty(Utils::$context['force_form_onsubmit']) ? ' onsubmit="' . Utils::$context['force_form_onsubmit'] . '"' : '', ' class="windowbg noup settings-grid">';
