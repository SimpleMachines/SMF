...
function template_main()
{
	...
	<div id="split_topics">
		...
		<div class="windowbg">
			...
			<ul>
				<li>
					<a href="', Config::$scripturl, '?board=', Utils::$context['current_board'], '.0">', $txt['message_index'], '</a>
				</li>
				<li>
					<a href="', Config::$scripturl, '?topic=', Utils::$context['old_topic'], '.0">', $txt['origin_topic'], '</a>
				</li>
				<li>
					<a href="', Config::$scripturl, '?topic=', Utils::$context['new_topic'], '.0">', $txt['new_topic'], '</a>
				</li>
			</ul>
		</div><!-- .windowbg -->
	</div><!-- #split_topics -->';
...
function template_select()
{
	...
	echo '
			...
			<div id="selected" class="floatright">
				<div class="cat_bar">
					<h3 class="catbg">
						', $txt['split_selected_posts'], ' (<a href="', Config::$scripturl, '?action=splittopics;sa=selectTopics;subname=', Utils::$context['topic']['subject'], ';topic=', Utils::$context['topic']['id'], '.', Utils::$context['not_selected']['start'], ';start2=', Utils::$context['selected']['start'], ';move=reset;msg=0" onclick="return select(\'reset\', 0);">', $txt['split_reset_selection'], '</a>)
					</h3>
				</div>
				<div class="information">
