...
$txt['mc_reportedp_ignore_confirm'] = 'Êtes-vous sûr de vouloir ignorer les futurs rapports concernant ce message? Ceci entrainera la désactivation de tout nouveaux rapports pour tous les modérateurs de ce forum.';
...
$txt['mc_memberreport_summary'] = 'Il y a eu %1$d rapport(s) concernant ce membre. Le dernier rapport était %2$s.';
$txt['mc_memberreport_whoreported_title'] = 'Membres qui ont signalé ce membre.';
...
$txt['report_action_message_saved'] = 'Vous avez créé un nouveau commentaire avec succès.';
$txt['report_action_message_edited'] = 'Vous avez modifié le commentaire avec succès.';
$txt['report_action_message_deleted'] = 'Ce message a été supprimé avec succès.';
$txt['report_action_message_edit_issue'] = 'Le message que vous essayez de modifier n\'est plus disponible. Veuillez vérifier s\'il n\'a pas déjà été supprimé.';
$txt['report_action_message_edit_cannot'] = 'Nous sommes désolé, vous nâ€™êtes pas autorisé de modifier ce commentaire.';
$txt['report_action_message_delete_cannot'] = 'Nous sommes désolé, vous nâ€™êtes pas autorise à supprimer ce commentaire.';
$txt['report_action_message_delete_issue'] = 'Le message que vous essayez de supprimer n\'est plus disponible. Veuillez vérifier s\'il n\'a pas déjà été supprimé.';
...
// Do not use numeric entries in the below string.
$txt['mc_reportedm_ignore_confirm'] = 'Êtes vous certain de vouloir ignorer tout futur rapport concernant le profil de cet utilisateur?\\n\\nCeci désactivera tout futur rapport pour tout le monde.';
