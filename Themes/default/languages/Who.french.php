...
$txt['who_admin'] = 'Consulte le centre d\'administration';
$txt['who_moderate'] = 'Consulte le centre de modération';
...
$txt['who_index'] = 'Consulte l\'accueil du forum <a href="' . $scripturl . '">' . $context['forum_name_html_safe'] . '</a>.';
$txt['who_viewprofile'] = 'Consulte le profil de <a href="' . $scripturl . '?action=profile;u=%1$d">%2$s</a>.';
$txt['who_viewownprofile'] = 'Visualise <a href="' . $scripturl . '?action=profile;u=%1$d">son propre profil</a>.';
