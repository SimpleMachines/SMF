...
$txt['smileys_location_form_description'] = 'These smileys will appear in the popup smiley box when posting a new forum message or Personal Message.';
$txt['smileys_location_popup_description'] = 'These smileys will be shown when a user clicks the \'more\' button in the smiley popup';
