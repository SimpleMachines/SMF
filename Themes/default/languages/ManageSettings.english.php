...
$txt['signature_max_images_note'] = '(0 for no max - excludes smilies)';
$txt['signature_allow_smilies'] = 'Allow smilies in signatures';
$txt['signature_max_smilies'] = 'Maximum smiley count';
