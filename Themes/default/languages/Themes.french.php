...
$txt['theme_install_error_file_7'] = 'Échec dâ€™écriture sur le disque.';
...
$txt['theme_adding'] = 'Vous pourrez toujours trouver de nouveaux thèmes pour votre forum dans la zone thèmes de SMF - <strong><a href="http://custom.simplemachines.org/themes/" target="_blank">http://custom.simplemachines.org/themes/</a></strong>. Vous pourrez les parcourir sur le site, lire les commentaires et les télécharger sur votre ordinateur puis les envoyer sur votre forum depuis là.<br><br> Si vous avez des questions au sujet des thèmes, chaque modification publiée sur simplemachines.org comporte un sujet dédié dans lequel les aides et commentaires devraient être postés.';
...
$txt['og_image_desc'] = 'Lien vers votre image optimisée par Open Graph, taille suggérée 175x175<br><span class="smalltext">Vous pouvez lire plus d\'informations chez <a href="http://ogp.me/">Open Graph</a></span> ';
