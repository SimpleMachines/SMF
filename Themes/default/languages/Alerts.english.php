...
$txt['alert_msg_report'] = '{member_link} reported a post - {msg_msg}';
$txt['alert_msg_report_reply'] = '{member_link} replied to the report about {msg_msg}';
$txt['alert_profile_report'] = '{member_link} reported the profile of {profile_msg}';
$txt['alert_profile_report_reply'] = '{member_link} replied to the report about the profile of {profile_msg}';
...
$txt['alert_paidsubs_expiring'] = 'Your subscription to {subscription_name} is about to expire at {end_time}';
