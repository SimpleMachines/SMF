...
$txt['alert_msg_unapproved_topic'] = '{member_link} started a new unapproved topic, {topic_msg}, in {board_msg}';
$txt['alert_msg_unapproved_post'] = '{member_link} made a new unapproved reply to {topic_msg} in {board_msg}';
$txt['alert_msg_unapproved_reply'] = '{member_link} replied to your unapproved topic, {topic_msg}, in {board_msg}';
