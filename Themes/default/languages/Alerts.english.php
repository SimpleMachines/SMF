...
$txt['alert_msg_unapproved_attachment'] = '{member_link} added a new unapproved attachment to the post {msg_msg} in {board_msg}';
$txt['alert_topic_unapproved_topic'] = '{member_link} started a new unapproved topic {topic_msg} in {board_msg}';
$txt['alert_topic_unapproved_post'] = '{member_link} made a new unapproved post {topic_msg} in {board_msg}';
