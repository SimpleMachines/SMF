...
$txt['not_found'] = 'This section isn\'t available at this time.';
...
$txt['register_to_use'] = 'You must sign up before using this feature.';
...
$txt['feature_disabled'] = 'This feature is disabled.';
$txt['feature_no_exists'] = 'This feature doesn\'t exist.';
...
$txt['cannot_calendar_post'] = 'Event posting isn\'t allowed.';
$txt['cannot_calendar_view'] = 'You are not allowed to view the calendar.';
$txt['cannot_remove_any'] = 'You don\'t have the privilege to remove this topic. Check to make sure this topic wasn\'t just moved to another board.';
...
$txt['cannot_pm_read'] = 'You can\'t read your personal messages.';
...
$txt['cannot_modify_own'] = 'You aren\'t allowed to edit your own posts.';
...
$txt['cannot_poll_add_own'] = 'You aren\'t allowed to add polls to your own topics in this board.';
...
$txt['cannot_poll_lock_any'] = 'You aren\'t allowed to lock polls.';
...
$txt['cannot_poll_vote'] = 'You cannot vote in polls in this board.';
$txt['cannot_post_attachment'] = 'You don\'t have permission to post attachments here.';
$txt['cannot_post_new'] = 'You cannot post new topics in this board.';
...
$txt['cannot_profile_remove_own'] = 'You aren\'t allowed to delete your own account.';
...
$txt['cannot_profile_extra_own'] = 'You don\'t have the necessary permissions to edit your profile data.';
...
$txt['cannot_delete_replies'] = 'You cannot remove these posts, even though they are replies to your topic.';
...
$txt['cannot_issue_warning'] = 'You do not have permission to issue warnings to members.';
$txt['cannot_send_email_to_members'] = 'The administrator has disallowed sending emails on this board.';
...
$txt['cannot_who_view'] = 'You don\'t have the proper permissions to view the Who\'s Online list.';
...
$txt['registration_disabled'] = 'Registration is currently disabled.';
$txt['registration_no_secret_question'] = 'There is no secret question set for this member.';
$txt['poll_range_error'] = 'The poll must run for more than 0 days.';
...
$txt['incorrect_answer'] = 'You did not answer your question correctly. Please click back to try again, or click back twice to use the default method of obtaining your password.';
...
$txt['login_threshold_fail'] = 'You are out of login chances. Please come back and try again later.';
$txt['login_threshold_brute_fail'] = 'You\'ve reached your login attempts threshold for account %1$s. Please wait 30 seconds and try again later.';
...
$txt['login_WaitTime_broken'] = 'You will have to wait about %1$d seconds to login again.';
...
$txt['too_many_groups'] = 'You selected too many groups, please remove some from your selection.';
...
$txt['register_only_once'] = 'You are not allowed to register multiple accounts at the same time from the same computer.';
...
$txt['error_bad_file'] = 'The file specified could not be opened: %1$s';
...
$txt['not_on_simplemachines'] = 'Packages can only be downloaded like this from the simplemachines.org server.';
...
$txt['error_functionality_not_windows'] = 'This functionality is currently not available for servers running Windows.';

// Don't use entities in the below string.
$txt['attachment_not_found'] = 'Attachment not found';

$txt['error_no_boards_selected'] = 'No valid boards were selected.';
$txt['error_no_boards_available'] = 'There are no boards available to you at this time.';
...
// Registration form.
$txt['under_age_registration_prohibited'] = 'Users under the age of %1$d are not allowed to register on this forum.';
...
$txt['name_censored'] = 'The name you tried to use, %1$s, contains words which have been censored. Please try another name.';
...
$txt['loadavg_generic_disabled'] = 'Because of high stress on the server, this feature is currently unavailable.';
