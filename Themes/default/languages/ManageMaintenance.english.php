...
$txt['backtrace_info'] = '<strong>#%1$d</strong>: %2$s()<br>Called from <a href="' . $scripturl . '?action=admin;area=logs;sa=errorlog;file=%5$s;line=%4$d" onclick="return reqWin(this.href, 600, 480, false);">%3$s on line %4$d</a>';
