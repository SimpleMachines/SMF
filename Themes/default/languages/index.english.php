...
$txt['member_warn_watch'] = 'User is on moderator watch list';
$txt['member_warn_moderate'] = 'User posts join approval queue';
$txt['member_warn_mute'] = 'User is banned from posting';
