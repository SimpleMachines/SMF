...
$txt['tfa_profile_lable'] = 'Two-Factor Authentication';
...
$txt['tfa_desc'] = 'In order to have Two-Factor Authentication, you would need a compatible app such as Google Authenticator on your device. Once you have enabled TFA for your account, you will be required to enter a code on login via the paired device alongside your username and password in order to successfully login. After you have enabled TFA, a backup code will be provided should you lose your paired device.';
$txt['tfa_step1'] = '1. Enter the secret';
$txt['tfa_step1_desc'] = 'In order to setup the app, either scan the QR code on the right side or enter the following code manually: ';
$txt['tfa_step2'] = '2. Enter the code generated by the app';
