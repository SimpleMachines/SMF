...
$helptxt['minimize_files'] = 'This option will minimize the CSS and JavaScript files used by your forum, could reducing the request calls to your server and could speeding up load times for your users.<br><br>You should use your browser development view to see if enable or disable provide a better/faster calling time of your page.';
