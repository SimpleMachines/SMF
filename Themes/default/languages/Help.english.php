...
$helptxt['use_lightbox'] = 'When enabled, images in a message can be displayed enlarged. If you have more than one image in a message, it will be shown in a gallery.';
