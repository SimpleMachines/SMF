...
$txt['sql_file'] = 'Le fichier de modification a été extrait. Il est accompagné d\'un fichier SQL afin de modifier votre base de données.  Vous devrez lâ€™exécuter pour que la modification fonctionne correctement.';
...
$txt['could_not_package_backup'] = 'Une sauvegarde n\'a pu être générée avant de faire les changements. Aucun changement n\'a été effectue à ce moment (vous devrez soit changer les permissions dâ€™écriture de Packages/backup ou désactiver les sauvegardes - non recommandé)';
...
$txt['packages_adding'] = 'Vous pourrez toujours trouver de nouveaux paquets pour votre forum depuis la zone modifications de SMF - <strong><a href="http://custom.simplemachines.org/mods/" target="_blank">http://custom.simplemachines.org/mods/</a></strong>. Vous pourrez les parcourir depuis le site, lire les commentaires et les télécharger sur votre ordinateur puis les installer sur votre forum depuis là bas.<br><br>Si vous avez des questions concernant ces modifications, chacun est publiée sur simplemachines.org et comporte un sujet dédié pour tout ce qui est support et commentaires. ';
...
$txt['package_no_zlib'] = 'Désolé, votre configuration de PHP n\'inclut pas le support pour <strong>zlib</strong>.  Sans cela, le gestionnaire de paquets ne peut pas fonctionner.  Veuillez contacter votre hébergeur pour plus d\'informations à ce sujet.';
