	...
	foreach ($context['groups'] as $group)
	{
		...
		echo '
					<tr class="windowbg', $alternate ? '2' : '', '">
						<td>
							', !empty($group['help']) ? ' <a class="help" href="' . $scripturl . '?action=helpadmin;help=' . $group['help'] . '" onclick="return reqOverlayDiv(this.href);"><span class="generic_icons help"></span></a>' : '<img class="icon" src="' . $settings['images_url'] . '/blank.png" alt="' . $txt['help'] . '">', '&nbsp;<span>', $group['name'], '</span>';
			...
			<div id="permissions_panel_advanced" class="windowbg2">
				<fieldset>
					...
					<dl class="settings admin_permissions">
						<dt>
							<a class="help" href="', $scripturl, '?action=helpadmin;help=permissions_quickgroups" onclick="return reqOverlayDiv(this.href);"><span class="generic_icons help"></span></a>', $txt['permissions_apply_pre_defined'], ':
						</dt>
						<dd>
			...
			foreach ($permissionGroup['permissions'] as $permission)
			{
				if (!$permission['hidden'] && !$permissionGroup['hidden'])
				{
					echo '
						<tr>
							<td width="10">
								', $permission['show_help'] ? '<a href="' . $scripturl . '?action=helpadmin;help=permissionhelp_' . $permission['id'] . '" onclick="return reqOverlayDiv(this.href);" class="help"><span class="generic_icons help"></span></a>' : '', '
							</td>
