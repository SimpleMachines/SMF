...
function template_main()
{
	...
	echo '
	<div id="edit_poll">
		<form action="' . Config::$scripturl . '?action=editpoll2', Utils::$context['is_edit'] ? '' : ';add', ';topic=' . Utils::$context['current_topic'] . '.' . Utils::$context['start'] . '" method="post" accept-charset="UTF-8" name="postmodify" id="postmodify">
			<div class="cat_bar">
			...
			<div>
				<div class="roundframe noup">
					...
					<fieldset id="poll_main">
						...
						<dl class="settings poll_options" data-more-txt="', Lang::getTxt('poll_add_option', file: 'Post'), '" data-option-txt="', Lang::getTxt('option', file: 'Post'), '">
	...
	echo '
					<input type="submit" name="post" value="', Lang::getTxt('save', file: 'General'), '" accesskey="s" class="button">
				</div><!-- .roundframe -->
			</div>
