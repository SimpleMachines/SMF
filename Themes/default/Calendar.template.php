...
function template_calendar_top($calendar_data)
{
	...
	echo '
			<form action="', $scripturl, '?action=calendar;', $context['calendar_view'], '" id="', !empty($calendar_data['end_date']) ? 'calendar_range' : 'calendar_navigation', '" method="post" accept-charset="', $context['character_set'], '">
				<input type="date" name="start_date" id="start_date" value="', trim($calendar_data['start_year'] . '-' . $calendar_data['start_month'] . '-' . $calendar_data['start_day']), '" tabindex="', $context['tabindex']++, '" class="date_input start" data-type="date">';

	if (!empty($calendar_data['end_date']))
		echo '
				<span>', strtolower($txt['to']), '</span>
				<input type="date" name="end_date" id="end_date" value="', trim($calendar_data['end_year'] . '-' . $calendar_data['end_month'] . '-' . $calendar_data['end_day']), '" tabindex="', $context['tabindex']++, '" class="date_input end" data-type="date">';
					...
					<fieldset id="event_options">
						...
						<div class="event_options_left" id="event_time_input">
							...
							<div>
								...
								<input type="date" name="end_date" id="end_date" value="', substr(trim($context['event']['end_datetime']), 0, 10), '" tabindex="', $context['tabindex']++, '" class="date_input end" data-type="date"', $modSettings['cal_maxspan'] == 1 ? ' disabled' : '', '>
