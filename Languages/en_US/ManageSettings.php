...
$txt['securityDisable_credentials'] = 'Disable security for changing sign in methods';
$txt['auth_stepup_lifetime'] = 'How long proving who you are lasts, in seconds';
$txt['auth_stepup_lifetime_subtext'] = 'Applies to the administration and moderation centres. Leave empty for an hour.';
$txt['auth_credentials_lifetime'] = 'How long it lasts for changing sign in methods, in seconds';
$txt['auth_credentials_lifetime_subtext'] = 'A passkey or a linked account outlives the session it was added from, so this is deliberately shorter. Leave empty for five minutes.';
