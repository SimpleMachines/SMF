...
$txt['permissions_deny_dangerous'] = 'You are about to deny one or more permissions.\\nThis can be dangerous and cause unexpected results if you have not made sure no one is accidentally in the group or groups you are denying permissions to.\\n\\nAre you sure you want to continue?';
...
$txt['permissionhelp_manage_smileys'] = 'This allows access to the smiley center. In the smiley center you can add, edit and remove smileys and smiley sets. If you have enabled customized message icons you are also able to add and edit message icons with this permission.';
...
$txt['permissionhelp_post_new'] = 'This permission allows users to post new topics. It does not allow to post replies to topics.';
...
$txt['permissionhelp_remove'] = 'Delete topics as a whole. Note that this permission does not allow to delete specific messages within the topic!';
...
$txt['permissionhelp_view_attachments'] = 'Attachments are files that are attached to posted messages. This feature can be enabled and configured in "Attachments and avatars". Since attachments are not directly accessed, you can protect them from being downloaded by users that do not have this permission.';
