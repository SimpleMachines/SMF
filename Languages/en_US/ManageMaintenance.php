...
$txt['maintain_logs_info'] = 'Clear out all information-related logs, xuch as the error log. This should be avoided unless something is wrong, and will not adversely affect forum operations';
