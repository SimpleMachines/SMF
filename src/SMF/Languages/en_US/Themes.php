...
$txt['theme_install_error'] = 'That theme directory does not exist, or does not contain a theme.';
...
$txt['theme_install_no_action'] = 'This is not a valid install action.';
...
$txt['who_display_viewing_off'] = 'Do not show';
...
$txt['themeadmin_admin_desc'] = 'This page allows you to change the default theme, reset members to all use a certain theme, and choose other settings related to theme selection. You are also able to install themes from here.<br><br>Do not forget to look at the theme settings for your themes for layout options.';
...
$txt['themeadmin_reset_options_info'] = 'The options below will reset options for <em>everyone</em>. To change an option, select &quot;change&quot; in the box next to it, and then select a value for it. To use the default, select &quot;default&quot;. Otherwise, use &quot;do not change&quot; to keep it as-is.';
$txt['themeadmin_reset_options_change'] = 'Change';
$txt['themeadmin_reset_options_none'] = 'Do not change';
...
$txt['themeadmin_edit_copy_warning'] = 'When SMF needs a template or language file which is not in the current theme, it looks in the theme it is based on, or the default theme.<br>Unless you need to modify a template, it is better not to copy it.';
...
$txt['themeadmin_browsing_theme'] = 'Browsing files in theme: {name}';
